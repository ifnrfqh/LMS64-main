                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-info">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('tugas.edit', [$pelajaran->id, $tugas->id]) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="deskripsi">{{ $tugas->deskripsi }}</textarea>
                                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('file.delete', [$pelajaran->id, $tugas->id, $detail->id]) }}"
