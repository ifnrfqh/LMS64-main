...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 grid-margin stretch-card d-flex flex-column gap-3 list-materi">
            @foreach ($tugass as $i => $list)
                <a href="{{ route('siswa.tugas.show', [$pelajaran->id, $list->id]) }}" style=" text-decoration: none;">
                    <div class="card card-list {{ $tugas->id === $list->id ? 'card-active' : '' }}">
