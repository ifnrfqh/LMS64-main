...
Route::middleware(['auth', 'userAkses:guru'])->group(function () {
    ...
    Route::get('/tugas/{pelajaran}', [TugasController::class, 'guruIndex'])->name('guru.tugas');
    Route::get('/tugas/{pelajaran}/{idTugas}', [TugasController::class, 'show'])->name('tugas.show');
    ...
    Route::put('/tugas/{pelajaran}/{idTugas}', [TugasController::class, 'editTugas'])->name('tugas.edit');
    Route::delete('/tugas/{pelajaran}/{idTugas}', [TugasController::class, 'destroy'])->name('tugas.destroy');
    Route::delete('/tugas/{pelajaran}/{idTugas}/{idFile}', [TugasController::class, 'deleteFile'])->name('tfile.delete');
});
Route::middleware(['auth', 'userAkses:siswa'])->group(function () {
    ...
    Route::get('/tugassiswa/{pelajaran}', [TugasController::class, 'siswaIndex'])->name('siswa.tugas');
    Route::get('/tugassiswa/{idPelajaran}/{idTugas}', [TugasController::class, 'siswaShow'])->name('siswa.tugas.show');
});
